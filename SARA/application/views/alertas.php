...
<html lang="es">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>SARA :: Consulta de alertas</title>
        ...
        <p class="paragraph1">Consulta de alertas</p>

        <script src="http://localhost/ionauth/js/jugar.js"></script>

    </head>

    <body>
    
        <form action="alertas_graph" method="post">
      Piso:<br>
       <select name="piso">
